...
import { weatherCache } from '@/app/lib/client/weatherCache';
import styles from '@/app/components/widget/Widget.module.css';
...
const Widget = ({ isFullscreen }: { isFullscreen: boolean }) => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      if (weatherCache.isValid()) {
        const cachedData = weatherCache.get() as CachedData;
