...
This folder contains the core components for integrating the Weather Man with Supabase, a PostgreSQL-based serverless database service.
...
```ts
import { addDataToDb } from '@/app/lib/supabase/addToDb';
...
| ------------------------------------------------------ | ----------------------------------------------------------- |
| `SUPABASE_URL` or `NEXT_PUBLIC_SUPABASE_URL`           | The URL of your Supabase project                            |
| `SUPABASE_ANON_KEY` or `NEXT_PUBLIC_SUPABASE_ANON_KEY` | The anonymous key for your Supabase project                 |
| `SUPABASE_TABLE_NAME`                                  | The name of the table (default: "weather_man_weather_data") |
